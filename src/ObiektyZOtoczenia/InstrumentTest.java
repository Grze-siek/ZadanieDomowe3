...
public class InstrumentTest {
    public static void main(String[] args) {
      ...
      /*  StringedInstrument guitar1 = new StringedInstrument();
        ...
        */
        StringedInstrument guitar1 = new StringedInstrument("acoustic guitar", "Fender", 6, 1500, true);
        StringedInstrument guitar2 = new StringedInstrument("classic guitar", "Alvaro", 6, 999.5, false);
